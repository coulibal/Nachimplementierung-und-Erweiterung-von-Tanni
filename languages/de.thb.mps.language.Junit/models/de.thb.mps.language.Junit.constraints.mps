...
<model ref="r:18e2b31c-0418-4415-9186-87894017ec32(de.thb.mps.language.Junit.constraints)">
  ...
  <node concept="1M2fIO" id="5jqLHSbUk3A">
    <ref role="1M2myG" to="4d0a:pnD2XhvlAh" resolve="Test" />
    <node concept="EnEH3" id="5jqLHSbUkp3" role="1MhHOB">
      <ref role="EomxK" to="4d0a:5eKUb7Dw13f" resolve="description" />
